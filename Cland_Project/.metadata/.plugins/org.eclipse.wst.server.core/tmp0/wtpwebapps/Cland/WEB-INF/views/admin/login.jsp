...
<html>
  <head>
    ...
    <link rel="shortcut icon" type="image/ico" href="${contextPath}/admin/images/icon-180x180.png" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!-- Bootstrap -->
    <link href="${contextPath}/admin/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- styles -->
				...
				<div class="login-wrapper">
			        <div class="box">
			            <div class="content-wrap">
			            	<img width="100px" height="100px" class="img-circle" src="${contextPath}/admin/images/icon-180x180.png">
			                <h6>Đăng nhập</h6>
